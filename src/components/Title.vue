<template>
  <div class="titleContainer">
    <div class="titleContainer__title">
        <div v-for="(letter, index) in letters" :key="index" class="titleContainer__title__letterContainer" @mousemove="onMouseMove($event, index)" @mouseleave="onMouseLeave(index)">
...
export default {
  ...
  methods: {
    onMouseMove(event, index) {
      ...
      const fontWeight = this.minFontWeight + (1 - distancePercentage) * (this.maxFontWeight - this.minFontWeight);
